...
const AddProduct = () => {
    const [values, setValues] = useState({
        ...
        shipping: '',
        quantity: '',
        photo: '', // Ensure it's used if needed or remove this line
        author: '',
        loading: false,
        error: '',
        createdProduct: '',
    ...
    const {
        ...
        shipping,
        quantity,
        // photo, // Include this only if needed or comment out to avoid unused variable warning
        author,
        loading,
        error,
        createdProduct,
    ...
    const showSuccess = () => (
        <div className="alert alert-info" style={{ display: createdProduct ? '' : 'none' }}>
            <h2>{`${createdProduct}`} is created! continue shoping.</h2>
        </div>
    );
